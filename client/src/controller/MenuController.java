...
public class MenuController {
    ...
    private void PopupNameWindow() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/PopupName.fxml"));
    ...
    public void ThreeCardButtonClick(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/NorthernPoker.fxml"));
