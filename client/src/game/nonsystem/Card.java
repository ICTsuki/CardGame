...
import game.gameenum.Rank;
import game.gameenum.Suit;
import java.util.*;
...
public class Card {
    ...
    public static final String BACK_IMAGE_PATH = "/resource/image/card/backs/Back3.png";
    ...
    public Card(Suit suit, Rank rank) {
        ...
        if(suit.equals(Suit.CLUB)) {
            this.frontImagePath = "/resource/image/card/clubs/C" + rank.getValue() + ".png";
        } else if(suit.equals(Suit.SPADE)) {
            this.frontImagePath = "/resource/image/card/spades/S" + rank.getValue() + ".png";
        }else if (suit.equals(Suit.DIAMOND)) {
            this.frontImagePath = "/resource/image/card/diamonds/D" + rank.getValue() + ".png";
        }else {
            this.frontImagePath = "/resource/image/card/hearts/H" + rank.getValue() + ".png";
        }
    }
